...
// module.exports = function addTask(req, res, next) {
//     var data = req.body;
...
// module.exports = function removeTask(req, res, next) {
...
// module.exports = function changeStatusTask(req, res, next) {
//     var ObjectID = new mongodb.ObjectID(req.params.id);
...
module.exports = function listTasks(req, res, next) {
